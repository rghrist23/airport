        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="intro-message">
                    <h1><img src="img/logos/AMS_icon_light.png" class="img-responsive center-block" width="150"
                             height="229"</h1>
                    <h3>The system for Airports</h3>
                    <hr class="intro-divider">
                    <div class="pagination">
                        <button type="button" class="btn btn-success btn-lg" data-toggle="modal" href="#login-overlay">
                            Login
                        </button>
                        <br> <br>
